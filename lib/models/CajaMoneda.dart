...
class CajaMoneda extends amplify_core.Model {
  ...
  const CajaMoneda._internal({required this.id, required cajaID, required negocioID, required moneda, required denominacion, required monto, required isDeleted, createdAt, updatedAt}): _cajaID = cajaID, _negocioID = negocioID, _moneda = moneda, _denominacion = denominacion, _monto = monto, _isDeleted = isDeleted, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CajaMoneda({String? id, required String cajaID, required String negocioID, required String moneda, required double denominacion, required double monto, required bool isDeleted, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
