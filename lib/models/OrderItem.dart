...
class OrderItem extends amplify_core.Model {
  ...
  const OrderItem._internal({required this.id, required orderID, required productoID, required quantity, tax, required subtotal, required total, isDeleted, createdAt, updatedAt}): _orderID = orderID, _productoID = productoID, _quantity = quantity, _tax = tax, _subtotal = subtotal, _total = total, _isDeleted = isDeleted, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory OrderItem({String? id, required String orderID, required String productoID, required int quantity, int? tax, required double subtotal, required double total, bool? isDeleted, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
  ...
  OrderItem copyWith({String? orderID, String? productoID, int? quantity, int? tax, double? subtotal, double? total, bool? isDeleted, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
    return OrderItem._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'orderID': _orderID, 'productoID': _productoID, 'quantity': _quantity, 'tax': _tax, 'subtotal': _subtotal, 'total': _total, 'isDeleted': _isDeleted, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
