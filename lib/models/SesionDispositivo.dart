...
class SesionDispositivo extends amplify_core.Model {
  ...
  const SesionDispositivo._internal({required this.id, required negocioId, required userId, required deviceId, required deviceType, deviceInfo, required isActive, required lastActivity, createdAt, updatedAt}): _negocioId = negocioId, _userId = userId, _deviceId = deviceId, _deviceType = deviceType, _deviceInfo = deviceInfo, _isActive = isActive, _lastActivity = lastActivity, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory SesionDispositivo({String? id, required String negocioId, required String userId, required String deviceId, required String deviceType, String? deviceInfo, required bool isActive, required amplify_core.TemporalDateTime lastActivity, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
